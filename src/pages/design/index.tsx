...
const ChatPage: React.FC = () => {
    ...
    try {
      ...
      if (isIpAddress) {
        ...
        Taro.showModal({
          title: "提示",
          content:
            "检测到使用IP地址访问图片，如果无法加载，请在微信小程序后台配置域名白名单：117.50.252.189",
          showCancel: false,
        });
      }
  ...
  console.log(messages, helloMessage, '11111')
      ...
      <View className="assistant-container">
        ...
        <View className="message-container">
          ...
          <View className="message-wrapper">
            ...
            {messages[0] ? (
              <ChatBubble message={messages[0].content || ""} />
            ) : (
              <ChatBubble message={helloMessage} />
            )}
          </View>
        </View>
      </View>
